...
Route::post('custom_store/', 'CustomPageController@customStore')->name('custom_store')->middleware(['auth', 'XSS']);
...
Route::get('join_us/delete//{key}', 'JoinUsController@destroy')->name('join_us_destroy')->middleware(['auth', 'XSS']);
