...
Route::prefix('client')->as('client.')->group(function () {
    ...
    Route::any('/{slug}/calendar/{id?}', [CalenderController::class, 'calendar'])->name('calenders.google.calendar')->middleware(['auth:client', 'XSS']);
    ...
    // Route::post('invoice/{id}/changeaction', [BankTransferController::class, 'invoiceChangeStatus'])->name('invoice.changestatus');
    ...
    // bug report
    Route::get('/{slug}/projects/{id}/bug_report', [ProjectController::class, 'bugReport'])->name('projects.bug.report');
    Route::get('/{slug}/projects/{id}/bug_report/create', [ProjectController::class, 'bugReportCreate'])->name('projects.bug.report.create');
    Route::post('/{slug}/projects/{id}/bug_report', [ProjectController::class, 'bugReportStore'])->name('projects.bug.report.store');
    Route::post('/{slug}/projects/{id}/bug_report/order-update', [ProjectController::class, 'bugReportOrderUpdate'])->name('projects.bug.report.update.order');
    Route::get('/{slug}/projects/{id}/bug_report/{bid}/edit', [ProjectController::class, 'bugReportEdit'])->name('projects.bug.report.edit');
    Route::post('/{slug}/projects/{id}/bug_report/{bid}/update', [ProjectController::class, 'bugReportUpdate'])->name('projects.bug.report.update');
    Route::delete('/{slug}/projects/{id}/bug_report/{bid}', [ProjectController::class, 'bugReportDestroy'])->name('projects.bug.report.destroy');
...
Route::any('/{slug}/paytab-success/invoice', [PaytabController::class, 'getInvoicePaymentStatus'])->name('invoice.paytab.success');
...
Route::group(['middleware' => ['verified']], function () {
    ...
    Route::prefix('client')->as('client.')->group(function () {
        ...
        Route::get('/my-account', [ClientController::class, 'account'])->name('users.my.account')->middleware(['auth:client', 'XSS']);
        ...
        Route::any('/{slug}/invoice/toyyibpay/{invoice}/{amt}', [ToyyibpayController::class, 'getInvoicePaymentStatus'])->name('invoice.toyyibpay')->middleware(['auth:client']);
        ...
        Route::any('/{slug}/paytab-success/invoice', [PaytabController::class, 'getInvoicePaymentStatus'])->name('invoice.paytab.success')->middleware(['auth:client', 'XSS']);
        ...
        Route::any('{slug}/event/get_event_data', [ZoomMeetingController::class, 'get_event_data'])->name('events.get_event_data')->middleware(['auth:client', 'XSS']);
    });
    ...
    Route::post('plan-pay-with-paymentwall/{plan}/{frequency}/{coupon?}', [PaymentWallPaymentController::class, 'planPayWithPaymentwall'])->name('plan.pay.with.paymentwall')->middleware(['auth', 'XSS']);


    // Calender
    Route::get('/{slug}/calendar/{id?}', [CalenderController::class, 'index'])->name('calender.index')->middleware(['auth', 'XSS']);
    Route::any('/{slug}/calendar/{id?}', [CalenderController::class, 'calendar'])->name('calender.google.calendar')->middleware(['auth', 'XSS']);
    ...
    Route::post('/admin/settings', [SettingsController::class, 'store'])->name('settings.store')->middleware(['XSS']);
    ...
    Route::get('/{slug}/userlogs/{id}', [LoginDetailController::class, 'show'])->name('users_logs.show')->middleware(['auth', 'CheckPlan', 'XSS']);
    ...
    //
    Route::post('/{slug}/users/addPromotion/{id}', [UserController::class, 'addPromotion'])->name('users.addPromotion')->middleware(['auth', 'XSS']);
    Route::get('/{slug}/users/addPromotionEdit/{id}', [UserController::class, 'addPromotionEdit'])->name('users.addPromotionEdit')->middleware(['auth', 'XSS']);
    //
    ...
    Route::get('plan/status/{planId}/{getAmount?}/{frequency?}/{couponCode?}', [ToyyibpayController::class, 'status'])->name('plan.status');

    Route::post('payfast-plan/', [PayfastController::class, 'index'])->name('payfast.payment')->middleware(['auth']);
    Route::any('payfast-plan-status/{success}', [PayfastController::class, 'success'])->name('payfast.payment.success')->middleware(['auth']);

    //Iyzipay Route
    Route::post('iyzipay/prepare', [IyziPayController::class, 'initiatePayment'])->name('plan.pay.with.iyzipay');
    Route::post('iyzipay/callback/plan/{id}/{amount}/{frequency}/{coupan_code?}', [IyzipayController::class, 'getPaymentStatus'])->name('plan.iyzipay');

    //sspay route
    Route::post('sspay-prepare-plan', [SspayController::class, 'SspayPaymentPrepare'])->middleware(['auth'])->name('plan.pay.with.sspay');
    Route::get('sspay-payment-plan/{plan_id}/{amount}/{frequency}/{couponCode?}', [SspayController::class, 'getPaymentStatus'])->middleware(['auth'])->name('plan.sspay');
    ...
    //paytab route
    Route::any('/payment/initiate', [BenefitPaymentController::class, 'planPayWithbenefit'])->name('plan.pay.with.benefit');
    Route::any('call_back', [BenefitPaymentController::class, 'getPaymentStatus'])->name('benefit.call_back');

    //cashfree route
    Route::post('cashfree/payments/store', [CashfreeController::class, 'planPayWithcashfree'])->name('plan.pay.with.cashfree');
    Route::any('cashfree/payments/success', [CashfreeController::class, 'getPaymentStatus'])->name('cashfreePayment.success');

    //aamarpay route
    Route::post('/aamarpay/payment', [AamarpayController::class, 'planPayWithaamarpay'])->name('plan.pay.with.aamarpay');
    Route::any('/aamarpay/success/{data}', [AamarpayController::class, 'getPaymentStatus'])->name('pay.aamarpay.success');
    ...
    Route::any('/{slug}/zoom-meeting/calender', [ZoomMeetingController::class, 'calender'])->name('zoommeeting.Calender')->middleware(['auth', 'XSS']);
    ...
    Route::any('/{slug}/Zoom-Meeting/calender', [ZoomMeetingController::class, 'calender'])->name('zoommeetings.Calender')->middleware(['auth:client', 'XSS']);
    Route::get('/{slug}/Zoom-Meeting/calender/create', [ZoomMeetingController::class, 'create'])->name('zoom_meeting.create')->middleware('auth', 'XSS'); //Create
    ...
    Route::post('/workspace/{slug}/google-calender', [WorkspaceController::class, 'pworkspa'])->name('google.calender.settings');
    ...
    // Route::get('{slug?}/email_template_langs/{id}/{lang?}', [EmailTemplateController::class, 'workspaceManageEmailLang'])->name('workspace.manage.email.language')->middleware(['auth']);
    ...
    // Route::get('{slug?}/email_templates' ,[EmailTemplateController::class , 'index'])->name('email_templates.index')->middleware(['auth']);
    ...
    /////
    Route::post('/{slug}/project_report_user_data', [ProjectReportController::class, 'ajax_data_report'])->name('projects.ajax_data_report')->middleware(['auth', 'XSS']);
    Route::get('/{slug}/user_project', [ProjectReportController::class, 'uerReport'])->name('user_project.uerReport')->middleware(['auth', 'XSS']);
    Route::get('/{slug}/graphShow/{id}', [ProjectReportController::class, 'graphShow'])->name('graphShow.graphShow')->middleware(['auth', 'XSS']);
    ...
    //================================= COOKIE CONSENT ====================================//
    Route::post('/cookie/settings', [SettingsController::class, 'saveCookieSettings'])->name('cookie.setting')->middleware(['auth', 'XSS']);
...
//
Route::get('arabic-index', function () {
    return view('task.arabic-index');
});
Route::get('arabic-about', function () {
    return view('task.arabic-about');
});

Route::get('arabic-contact', function () {
    return view('task.arabic-contact');
});


Route::get('arabic-pricing', function () {
    return view('task.arabic-pricing');
});

Route::get('arabic-service', function () {
    return view('task.arabic-service');
});
//
