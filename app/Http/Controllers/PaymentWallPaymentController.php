...
class PaymentWallPaymentController extends Controller
{
    ...
    public function planPayWithPaymentwall(Request $request,$plan_id ,$frequency , $coupon= '')
    {
    ...
    public function orderpaymenterror(Request $request,$flag,$slug,$invoice_id){
        if($flag == 1){
            return redirect()->back()->with('error', __('Transaction has been Successfull! '));
        }else{
