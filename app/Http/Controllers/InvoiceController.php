...
class InvoiceController extends Controller
{
    ...
    public function  payinvoice($slug, $invoice_id)
    {
        ...
        if ($currentWorkspace) {
            ...
            $currentWorkspace = Utility::getWorkspaceBySlug($slug);
            $paymentSetting   = Utility::getPaymentSetting(($currentWorkspace) ? $currentWorkspace->id : '');
    ...
    {   
        $objUser          = Auth::user();
        $currentWorkspace = Auth::user() ? Utility::getWorkspaceBySlug($slug) : Utility::getWorkspaceBySlug_copylink( 'invoice' , $id) ;
