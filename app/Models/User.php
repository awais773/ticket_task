...
class User extends Authenticatable implements MustVerifyEmail
{
    ...
    static public function userPlanFrequency($plan_id){

        $userPlanFrequency = Order::where('plan_id' , '=' , $plan_id)->where('user_id' , '=' , \Auth::user()->id)->orderBy('updated_at', 'desc')->first();
        
        $frequency = isset($userPlanFrequency->payment_frequency) ? $userPlanFrequency->payment_frequency : '';  
        return $frequency;
    }

    static public function Planrequest(){

        $userPlanFrequency1 = PlanRequest::first();
        return $userPlanFrequency1;
    }
