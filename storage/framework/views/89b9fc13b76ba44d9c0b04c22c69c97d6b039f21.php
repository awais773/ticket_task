                            ...
                            <div class="card-header">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 justify-content-end d-flex">
                                        <a data-size="lg" data-url="<?php echo e(route('feature_create')); ?>" data-ajax-popup="true"  data-bs-toggle="tooltip" data-title="<?php echo e(__('Create')); ?>"  class="btn btn-sm btn-primary">
                                                        ...
                                                        <td>
                                                            <span>
                                                                ...
                                                                <?php echo Form::open(['method' => 'GET', 'route' => ['feature_delete', $key],'id'=>'delete-form-'.$key]); ?>
                                                                    ...
                                                                    <a href="#" class="mx-3 btn btn-sm align-items-center bs-pass-para" data-bs-toggle="tooltip" title="<?php echo e(__('Delete')); ?>" data-original-title="<?php echo e(__('Delete')); ?>" data-confirm="<?php echo e(__('Are You Sure?').'|'.__('This action can not be undone. Do you want to continue?')); ?>" data-confirm-yes="<?php echo e('delete-form-'.$key); ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="logo-content mt-4">
                                                    <img id="image1" src="<?php echo e($logo.'/'. $settings['highlight_feature_image']); ?>"
                                                        class="big-logo img_setting" width="100%">
                                                </div>
                                                <div class="choose-file mt-5">
                                                    <label for="highlight_feature_image">
                                                        <div class=" bg-primary dark_logo_update" style="cursor: pointer;transform: translateY(+110%);"> <i class="ti ti-upload px-1">
                                                            </i><?php echo e(__('Choose file here')); ?>

                                                        </div>
                                                        <input type="file" name="highlight_feature_image" id="highlight_feature_image" class="form-control choose_file_custom" data-filename="highlight_feature_image">
                                                    </label>
                                                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ticket_task\Modules/LandingPage\Resources/views/landingpage/features/index.blade.php ENDPATH**/ ?>