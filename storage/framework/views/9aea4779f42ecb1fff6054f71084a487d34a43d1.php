 ...
 <?php $__env->startSection('action-button'); ?>
     <?php if(auth()->guard('web')->check()): ?>
         <?php if(Auth::user()->type == 'admin'): ?>
             <a href="<?php echo e(route('user.export')); ?>" class="btn btn-sm btn-primary" data-toggle="tooltip" title="<?php echo e(__('Export')); ?>">
             ...
             <a href="#" class="btn btn-sm btn-primary" data-ajax-popup="true" data-size="md"
                 data-title="<?php echo e(__('Add User')); ?>" data-url="<?php echo e(route('users.create')); ?>" data-toggle="tooltip"
                 title="<?php echo e(__('Add User')); ?>">
                 <i class="ti ti-plus"></i>
             </a>
         <?php elseif(isset($currentWorkspace) && $currentWorkspace->creater->id == Auth::id()): ?>
             <a href="<?php echo e(route('users_logs.index',$currentWorkspace->slug)); ?>" class="btn btn-sm btn-primary" data-title="<?php echo e(__('User Logs')); ?>" data-toggle="tooltip" title="<?php echo e(__('User Logs')); ?>">
                 <i class="ti ti-user-check"></i>
             </a>
             <a href="#" class="btn btn-sm btn-primary" data-ajax-popup="true" data-size="md"
                 data-title="<?php echo e(__('Invite')); ?>" data-url="<?php echo e(route('users.invite', $currentWorkspace->slug)); ?>"
                 data-toggle="tooltip" title="<?php echo e(__('Invite')); ?>">
                 <i class="ti ti-plus"></i>
             </a>
         <?php endif; ?>
     <?php endif; ?>
 ...
 <?php $__env->startSection('content'); ?>
     <?php if($currentWorkspace || Auth::user()->type == 'admin'): ?>
         <div class="row">
                     ...
                     <div class="card   text-center">
                         <div class="card-header border-0 pb-0">
                             <div class="d-flex justify-content-between align-items-center">
                                 <h6 class="mb-0">
                                     <?php if(Auth::user()->type == 'admin' && isset($user->getPlan)): ?>
                                         <div class="badge p-2 px-3 rounded bg-info"><?php echo e($user->getPlan->name); ?></div>
                                     <?php else: ?>
                                         ...
                                         <div class="dropdown-menu dropdown-menu-end">
                                             <?php if(Auth::user()->type == 'admin' && isset($user->getPlan)): ?>
                                                 <a href="#" class="dropdown-item" data-ajax-popup="true"
                                                     data-size="lg" data-title="<?php echo e(__('Change Plan')); ?>"
                                                     data-url="<?php echo e(route('users.change.plan', $user->id)); ?>"><i
                                                         class="ti ti-exchange"></i>
                                                     <span><?php echo e(__('Change Plan')); ?></span></a>
                                                 <a href="#" class="dropdown-item" data-ajax-popup="true"
                                                     data-size="md" data-title="<?php echo e(__('Reset Password')); ?>"
                                                     data-url="<?php echo e(route('users.reset.password', $user->id)); ?>"><i
                                                         class="ti ti-pencil"></i><span><?php echo e(__('Reset Password')); ?></span></a>

                                                 <a href="#" class="dropdown-item bs-pass-para "
                                                     data-confirm="<?php echo e(__('Are You Sure?')); ?>"
                                                     data-text="<?php echo e(__('This action can not be undone. Do you want to continue?')); ?>"
                                                     data-confirm-yes="delete_user_<?php echo e($user->id); ?>"><i
                                                         class="ti ti-trash"></i><span><?php echo e(__('Delete')); ?></span></a>
                                                 <form action="<?php echo e(route('users.delete', $user->id)); ?>" method="post"
                                                     id="delete_user_<?php echo e($user->id); ?>" style="display: none;">
                                                     <?php echo csrf_field(); ?>
                                                     <?php echo method_field('DELETE'); ?>
                                                 </form>
                                             <?php elseif(isset($currentWorkspace) &&
                                                 $currentWorkspace &&
                                                 $currentWorkspace->permission == 'Owner' &&
                                                 Auth::user()->id != $user->id): ?>
                                                 <a href="#" class="dropdown-item" data-ajax-popup="true"
                                                     data-size="md" data-title="<?php echo e(__('Edit User')); ?>"
                                 ...
                                 <?php if(Auth::user()->type == 'admin' && isset($user->getPlan)): ?>
                                     <button class="btn btn-sm btn-neutral mt-3 font-weight-500">
                                         <?php if(!empty($user->plan_expire_date)): ?>
                                             <a><?php echo e($user->is_trial_done == 1 ? __('Plan Trial') : __('Plan')); ?>

                                                 <?php echo e($user->plan_expire_date < date('Y-m-d') ? __('Expired') : __('Expires')); ?>

                                                 <?php echo e(__(' on ')); ?>

                                                 <?php echo e(date('d M Y', strtotime($user->plan_expire_date))); ?></a>
                                         <?php else: ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ticket_task\resources\views/users/index.blade.php ENDPATH**/ ?>