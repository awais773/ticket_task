    ...
    <div class="row">
        <div class="col-xl-3">
            <div class="card sticky-top" style="top:30px">
                <div class="list-group list-group-flush" id="useradd-sidenav">
                    <a href="#v-pills-home" class="list-group-item list-group-item-action border-0"><?php echo e(__('Account')); ?> <div
                    ...
                    <?php if(auth()->guard('client')->check()): ?>
                        <a href="#v-pills-billing"
                            class="list-group-item list-group-item-action border-0"><?php echo e(__('Billing Details')); ?> <div
                                class="float-end"><i class="ti ti-chevron-right"></i></div></a>
                    <?php endif; ?>
        ...
        <div class="col-xl-9">
            <div id="v-pills-home" class="card ">
                ...
                <div class="card-body">
                    <form method="post"
                        action="<?php if(auth()->guard('web')->check()): ?><?php echo e(route('update.account', [$workspace, $user_id])); ?><?php elseif(auth()->guard()->check()): ?><?php echo e(route('client.update.account', [$workspace, $user_id])); ?><?php endif; ?>"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <small
                                    class=""><?php echo e(__('Please upload a valid image file. Size of image should not be more than 2MB.')); ?></small>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <?php if($user->avatar != ''): ?>
                        <form
                            action="<?php if(auth()->guard('web')->check()): ?><?php echo e(route('delete.avatar')); ?><?php elseif(auth()->guard()->check()): ?><?php echo e(route('client.delete.avatar')); ?><?php endif; ?>"
    ...
    <div class="card" id="v-pills-profile">
        ...
        <div class="card-body">
            <form method="post"
                action="<?php if(auth()->guard('web')->check()): ?><?php echo e(route('update.password')); ?><?php elseif(auth()->guard()->check()): ?><?php echo e(route('client.update.password')); ?><?php endif; ?>">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    id="password_confirmation" placeholder="<?php echo e(__('Enter confirm password')); ?>">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control font-style" name="city" type="text"
                                value="<?php echo e($user->city); ?>" id="city">
                        </div>
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control" name="zipcode" type="text" value="<?php echo e($user->zipcode); ?>"
                                id="zipcode">
                        </div>
                        <div class="form-group  col-md-6">
                            <label for="country" class="form-label"><?php echo e(__('Country')); ?></label>
                            <input class="form-control font-style" name="country" type="text"
                                value="<?php echo e($user->country); ?>" id="country">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="telephone" class="form-label"><?php echo e(__('Telephone')); ?></label>
                            <input class="form-control" name="telephone" type="text" value="<?php echo e($user->telephone); ?>"
                                id="telephone">
                        </div>
                    </div>
                    <div class="row">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ticket_task\resources\views/users/account.blade.php ENDPATH**/ ?>