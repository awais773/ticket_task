...
<?php $__env->startSection('content'); ?>
    <section class="section">
        <?php if(Auth::user()->type == 'admin'): ?>
            <div class="row">
                <div class="col-12">
                    <?php if(empty(env('PUSHER_APP_ID')) ||
                        ...
                        <div class="alert alert-warning"><i class="fas fa-warning"></i>
                            <?php echo e(__('Please Add Pusher Details in Setting Page ')); ?><u><a
                                    href="<?php echo e(route('settings.index')); ?>"><?php echo e(__(' here')); ?></a></u></div>
                    <?php endif; ?>
                    <?php if(empty(env('MAIL_DRIVER')) ||
                        empty(env('MAIL_HOST')) ||
                        empty(env('MAIL_PORT')) ||
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h3 class="mb-0"><?php echo e($totalUsers); ?> <span class="text-success text-sm"></span></h3>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="text-muted text-sm mt-4 mb-2">
                                        ...
                                        <?php echo e(__('Order Amount')); ?> :
                                        <strong><?php echo e((env('CURRENCY_SYMBOL') != '' ? env('CURRENCY_SYMBOL') : '$') . $totalOrderAmount); ?></strong>
                                    </p>
                                    <h6 class="mb-3"><?php echo e(__('Total Orders')); ?></h6>
                                    <h3 class="mb-0"><?php echo e($totalOrders); ?> <span class="text-success text-sm"></span></h3>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="card">
                                <div class="card-body total_plan">
                                    ...
                                    <p class="text-muted text-sm mt-4 mb-2">
                                        <?php echo e(__('Most purchase plan')); ?> : <strong>
                                            <?php if($mostPlans): ?>
                                    ...
                                    <h3 class="mb-0"><?php echo e($totalPlans); ?> <span class="text-success text-sm"></span></h3>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <?php elseif(isset($currentWorkspace) && $currentWorkspace): ?>
        <script>
            ...
            setTimeout(function() {
                var taskAreaChart = new ApexCharts(document.querySelector("#projects-chart"), options);
    ...
    <?php elseif(isset($currentWorkspace) && $currentWorkspace): ?>
        ...
        <?php if(Auth::user()->getGuard() != 'client'): ?>
            <script>
                (function() {
                var options = {
                    series: [<?php echo json_encode($storage_limit); ?>],
                    chart: {
                        height: 475,
                        type: 'radialBar',
                        offsetY: -20,
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ticket_task\resources\views/home.blade.php ENDPATH**/ ?>