...
<br>
<div class="row">
    <p class="mb-0"><strong><?php echo e(__('Name')); ?>: </strong>  <?php echo e($objUser->name); ?></p>
    <p class="mb-0"><strong><?php echo e(__('Email')); ?>: </strong>  <?php echo e($objUser->email); ?></p>
</div>
<br>
<br>
<div class="row">
    ...
    <script>
        ...
        const myChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    label: <?php echo e(__('# of Reports')); ?>,
