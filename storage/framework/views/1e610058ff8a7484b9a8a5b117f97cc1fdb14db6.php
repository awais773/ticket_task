                                ...
                                <div class="d-grid">
                                    ...
                                    <?php endif; ?>
                                        ...
                                        <div class="d-grid col-12 mt-3">
                                                <a href="<?php echo e(route('login', $lang)); ?>" type="button" class="btn btn-primary btn-block mt-2" style="color:#fff"><?php echo e(__('User Login')); ?></a>
                                        </div>
                                            ...
                                            <a href="#" class="  btn-primary  ">
                                                <select name="language" id="language" class=" btn-primary btn " onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
                                                    <?php $__currentLoopData = App\Models\Utility::languages(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option class="login_lang" <?php if($lang == $language): ?> selected <?php endif; ?> value="<?php echo e(route('client.login',$language)); ?>"><?php echo e(ucfirst( \App\Models\Utility::getlang_fullname($language))); ?></option>
...
<style>
    ...
    </style><?php /**PATH C:\xampp\htdocs\ticket_task\resources\views/auth/client_login.blade.php ENDPATH**/ ?>