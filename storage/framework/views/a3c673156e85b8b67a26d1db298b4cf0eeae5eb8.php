...
<?php $__env->startSection('multiple-action-button'); ?>
    ...
    <?php if(
        ...
        <div class="col-md-auto col-sm-4 pb-3">
            <a href="#" class="btn btn-xs btn-primary btn-icon-only col-12" data-toggle="popover"  title="Shared Project Settings" data-ajax-popup="true" data-size="md" data-title="<?php echo e(__('Shared Project Settings')); ?>" data-url="<?php echo e(route('projects.copylink.setting.create',[$currentWorkspace->slug, $project->id])); ?>" data-toggle="tooltip" title="<?php echo e(__('Add Project')); ?>">
    ...
    <?php if(
        ...
        <div class="col-md-auto col-sm-4 pb-3">
            <a href="<?php echo e(route($client_keyword . 'projects.timesheet.index', [$currentWorkspace->slug, $project->id])); ?>"
                class="btn btn-xs btn-primary btn-icon-only col-12 "><?php echo e(__('Timesheet')); ?></a>
        </div>
    <?php endif; ?>
    <?php if(
        (isset($permissions) && in_array('show gantt', $permissions)) ||
            (isset($currentWorkspace) && $currentWorkspace->permission == 'Owner')): ?>
        <div class="col-md-auto col-sm-4 pb-3">
            <a href="<?php echo e(route($client_keyword . 'projects.gantt', [$currentWorkspace->slug, $project->id])); ?>"
                class="btn btn-xs btn-primary btn-icon-only col-12 "><?php echo e(__('Gantt Chart')); ?></a>
        </div>
    <?php endif; ?>
    <?php if(
        ...
        <div class="col-md-auto col-sm-4 pb-3">
            <a href="<?php echo e(route($client_keyword . 'projects.task.board', [$currentWorkspace->slug, $project->id])); ?>"
                class="btn btn-xs btn-primary btn-icon-only col-12 "><?php echo e(__('Task Board')); ?></a>
        </div>
    <?php endif; ?>
    <?php if(
        ...
        <div class="col-md-auto col-sm-6 pb-3">
            <a href="<?php echo e(route($client_keyword . 'projects.bug.report', [$currentWorkspace->slug, $project->id])); ?>"
                class="btn btn-xs btn-primary btn-icon-only col-12"><?php echo e(__('Bug Report')); ?></a>
        </div>
    <?php endif; ?>
    <div class="col-md-auto col-sm-6 pb-3 ">
        <a href="<?php echo e(route($client_keyword . 'projecttime.tracker', [$currentWorkspace->slug, $project->id])); ?>"
            class="btn btn-xs btn-primary btn-icon-only col-12 "><?php echo e(__('Tracker')); ?></a>
    </div>
<?php $__env->stopSection(); ?>
<style type="text/css">
    .fix_img {
                                ...
                                <div class="d-flex  align-items-center row1">
                                    <div class="px-3">
                                        ...
                                        <h5 class="text-white text-nowrap">
                                            <?php echo e(App\Models\Utility::dateFormat($project->start_date)); ?></h5>
                                    </div>
                                    <div class="px-3">
                                        <span class="text-white text-sm"><?php echo e(__('Due Date')); ?>:</span>
                                        <h5 class="text-white"><?php echo e(App\Models\Utility::dateFormat($project->end_date)); ?>
                                    ...
                                    <?php if(auth()->guard('web')->check()): ?>
                                        <?php if($currentWorkspace->permission == 'Owner'): ?>
                                            <div class="d-flex align-items-center ">
                                                ...
                                                <button class="btn btn-light d"><a href="#" class="bs-pass-para"
                                                        ...
                                                        data-toggle="popover" title="<?php echo e(__('Delete')); ?>"><i
                                        ...
                                        <?php else: ?>
                                            <button class="btn btn-light d"> <a href="#" class="bs-pass-para"
                                                    ...
                                                    data-confirm-yes="leave-form-<?php echo e($project->id); ?>"><i class="ti ti-trash">
                                                    </i> </i></a></button>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card " >
                                            ...
                                            <p class="text-muted d-sm-flex align-items-center mb-0">
                                                <?php if($currentWorkspace->permission == 'Owner'): ?>
                                                    <a href="#" class="btn btn-sm btn-primary "
                                                        ...
                                                        data-toggle="popover" title="<?php echo e(__('Invite')); ?>"
                                ...
                                <div class="card-body" >
                                    <div class="top-10-scroll" style="max-height: 300px;">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="float-end">
                                            <p class="text-muted d-none d-sm-flex align-items-center mb-0">
                                                <?php if($currentWorkspace->permission == 'Owner'): ?>
                                                    <a href="#" class="btn btn-sm btn-primary"
                                                        data-ajax-popup="true" data-title="<?php echo e(__('Share to Client')); ?>"
                                                        data-toggle="popover" title="<?php echo e(__('Share to Client')); ?>"
                                                ...
                                                <div class="row align-items-center justify-content-between">
                                                    <div class="col-sm-auto mb-3 mb-sm-0">
                                                        <div class="d-flex align-items-center px-2">
                                                            <a href="#" class=" text-start">
                                                                <img class="fix_img"
                                                                    <?php if($client->avatar): ?> src="<?php echo e(asset($logo . $client->avatar)); ?>" <?php else: ?> avatar="<?php echo e($client->name); ?>" <?php endif; ?>>
                                                            </a>
                                                            <div class="px-2">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header" style="padding: 25px 35px !important;">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="row">
                                            <h5 class="mb-0"><?php echo e(__('Progress')); ?><span class="text-end"> (<?php echo e(__('Last Week Tasks')); ?>)</span></h5>
...
<?php $__env->startPush('css-page'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('assets/custom/css/dropzone.min.css')); ?>">
<?php $__env->stopPush(); ?>
<?php $__env->startPush('scripts'); ?>
    ...
    <script src="<?php echo e(asset('assets/custom/js/dropzone.min.js')); ?>"></script>
    <script>
        ...
        myDropzone = new Dropzone("#dropzonewidget", {
            ...
            success: function(file, response) {
                if (response.is_success) {
                    ...
                    show_toastr('<?php echo e(__('Success')); ?>', 'File Successfully Uploaded' + '</br>' + '<span class="text-danger">' + response.result + '</span>' , 'success');
                } else {
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                if (response.is_success) {
                                    ...
                                    show_toastr('<?php echo e(__('Success')); ?>', 'File Successfully Deleted',
                                        'success');
                                } else {
                                    show_toastr('<?php echo e(__('Error')); ?>', 'Something Wents Wrong.',
                                        'error');
                                }
                            },
        ...
        <?php ($setting = App\Models\Utility::getAdminPaymentSetting()); ?>  
        <?php ($files = $project->files); ?>

        <?php $__currentLoopData = $files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php ($storage_file = ($logo_project_files . $file->file_path)); ?>
            // Create the mock file:
            <?php if((Storage::disk($setting['storage_setting'])->exists('/project_files/' . $file->file_path)) && ($project->id == $file->project_id)): ?>
                var mockFile = {
                    name: "<?php echo e($file->file_name); ?>",
                    size: <?php echo e(filesize('storage/project_files/' . $file->file_path)); ?>
            ...
            myDropzone.emit("thumbnail", mockFile, "<?php echo e(asset($logo_project_files . $file->file_path)); ?>");
            ...
            dropzoneBtn(mockFile, {
                ...
                delete: "<?php echo e(route($client_keyword . 'projects.file.delete', [$currentWorkspace->slug, $project->id, $file->id])); ?>"
            });
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ticket_task\resources\views/projects/show.blade.php ENDPATH**/ ?>