...
$avatar = asset(\App\Models\Utility::get_file('/users-avatar/')) ;
?>
...
<div class="shared-photo chat-image" style="background-image: url('<?php echo e(asset($image)); ?>')"></div>
<?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\ticket_task\resources\views/vendor/Chatify/layouts/listItem.blade.php ENDPATH**/ ?>