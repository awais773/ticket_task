...
unset($__errorArgs, $__bag); ?>"
                                            ...
                                            autocomplete="email" autofocus placeholder="<?php echo e(__('Enter Your Email')); ?>">
                                    </div>
                                    <div class="form-group mb-3">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <?php if(env('SIGNUP_BUTTON') == 'on'): ?>
                                        <p class="my-4 text-center">Don't have an account? <a
                            ...
                            <div class="d-grid mt-3">
                                    <a
                                        href="<?php echo e(route('client.login', $lang)); ?>" type="button" class="btn btn-primary btn-block" style="color:#fff">
                                        <?php echo e(__('Client Login')); ?></a>
                            </div>
                            <div class="row mt-4">
                                <div class="">
                                        ...
                                        <select name="language" id="language" class=" btn-primary btn "
                                            ...
                                            <?php $__currentLoopData = App\Models\Utility::languages(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option class="login_lang" <?php if($lang == $language): ?> selected <?php endif; ?>
                                                    value="<?php echo e(route('login', $language)); ?>"><?php echo e(ucfirst( \App\Models\Utility::getlang_fullname($language))); ?>
...
<?php echo $__env->make('layouts.guest', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ticket_task\resources\views/auth/login.blade.php ENDPATH**/ ?>