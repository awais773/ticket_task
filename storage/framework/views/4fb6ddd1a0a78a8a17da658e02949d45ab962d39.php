...
<?php $__env->startSection('action-button'); ?>
    <?php if(auth()->guard('web')->check()): ?>
        ...
        <a href="<?php echo e(route('project.export')); ?>"  class="btn btn-sm btn-primary "  data-toggle="tooltip" title="<?php echo e(__('Export Project')); ?>" > <i class="ti ti-file-x"></i></a>
                      ...
                      <div class="col-xl-3 col-lg-4 col-sm-6 All <?php echo e($project->status); ?>" >
                                <div class="card" >
                                    ...
                                    <?php endif; ?>
                                            ...
                                            <h5 class="mb-0">
                                             <?php if($project->is_active): ?>
                                            <a href="<?php if(auth()->guard('web')->check()): ?><?php echo e(route('projects.show',[$currentWorkspace->slug,$project->id])); ?><?php elseif(auth()->guard()->check()): ?><?php echo e(route('client.projects.show',[$currentWorkspace->slug,$project->id])); ?><?php endif; ?>" title="<?php echo e($project->name); ?>" class=""><?php echo e($project->name); ?><i class="ti ti-eye"></i></a>
                                            <?php else: ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ticket_task\resources\views/projects/index.blade.php ENDPATH**/ ?>