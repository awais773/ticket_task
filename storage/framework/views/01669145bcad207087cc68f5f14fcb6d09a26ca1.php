...
<div class="card-body">
    <div class="table-responsive">
        <?php echo e(Form::open(['route' => ['projects.copy.link', $projectID, $slug], 'method' => 'POST'])); ?>
        ...
        <table class="table mb-0">
            ...
            <tbody>
                ...
                <tr>
                    <td><?php echo e(__('Client')); ?></td>
                    <td class="action text-right">
                        <div class="form-check form-switch">
                            <input type="checkbox" name="client" class="form-check-input"
                                <?php if(isset($result->client) && $result->client == 'on'): ?> checked="checked" <?php endif; ?> id="copy_link_21"
                                value="on">
                    ...
                    <td class="action text-right">
                        <div class="form-check form-switch">
                            <input type="checkbox" name="bug_report" class="form-check-input"
                                <?php if(isset($result->bug_report) && $result->bug_report == 'on'): ?> checked="checked" <?php endif; ?> id="copy_link_6"
                                value="on">
                    ...
                    <td class="action text-right">
                        <div class="form-check form-switch">
                            <input type="checkbox" name="tracker_details" class="form-check-input"
                                <?php if(isset($result->tracker_details) && $result->tracker_details == 'on'): ?> checked="checked" <?php endif; ?> id="copy_link_8"
                                value="on">
                    ...
                    <td class="action text-right">
                        <div class="form-check form-switch">
                            <input type="checkbox" name="timesheet" class="form-check-input"
                                <?php if(isset($result->timesheet) && $result->timesheet == 'on'): ?> checked="checked" <?php endif; ?> id="copy_link_9"
                                value="on">
                ...
                <tr>
                    <td><?php echo e(__('Progress')); ?></td>
                    <td class="action text-right">
                        <div class="form-check form-switch">
                            <input type="checkbox" name="progress" class="form-check-input"
                                <?php if(isset($result->progress) && $result->progress == 'on'): ?> checked="checked" <?php endif; ?> id="copy_link_10"
                                value="on">
...
unset($__errorArgs, $__bag); ?>"
        ...
        <div class="row col-12 m-0">
            <div class="text-start col-6 py-3">
                <a href="#" class="btn btn-xs btn-primary btn-icon-only cp_link "
                data-link="<?php echo e(route('projects.link', [$currentWorkspace->slug, \Illuminate\Support\Facades\Crypt::encrypt($project->id)])); ?>"
...
<script>
    ...
    </script><?php /**PATH C:\xampp\htdocs\ticket_task\resources\views/projects/copylink_setting.blade.php ENDPATH**/ ?>