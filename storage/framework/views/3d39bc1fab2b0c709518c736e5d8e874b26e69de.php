            ...
            <header id="header" class="fixed-top d-flex align-items-center header-transparent">
                <div class="container d-flex justify-content-between align-items-center">
                    ...
                    <nav id="navbar" class="navbar">
                        <ul>
                            <li><a class="<?php echo e(Request::is('index') ? 'active' : ''); ?>"
                                    href="<?php echo e(url('index')); ?>">Home</a></li>
                            <li><a class="<?php echo e(Request::is('about') ? 'active' : ''); ?>"
                            ...
                            <li><a class="<?php echo e(Request::is('pricing') ? 'active' : ''); ?>"
                                    href="<?php echo e(url('pricing')); ?>">Pricing
                                    Plan</a></li>
                            <li><a class="<?php echo e(Request::is('contact') ? 'active' : ''); ?>"
                                    href="<?php echo e(url('contact')); ?>">Contact
                                    Us</a></li>

                            <li>
                                <a class="dropdown-item" href="">
                                    <?php echo $__env->yieldContent('language-bar'); ?></a>
                            </li>
...
<?php /**PATH C:\xampp\htdocs\ticket_task\resources\views/layouts/guest.blade.php ENDPATH**/ ?>