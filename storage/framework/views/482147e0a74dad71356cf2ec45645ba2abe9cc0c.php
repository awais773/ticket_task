...
<form class="" method="post" action="<?php echo e(route('notes.store',$currentWorkspace->slug)); ?>">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <input class="form-control" type="text" id="building_name" name="building_name" placeholder="<?php echo e(__('Enter Name')); ?>" required>
        </div>
        <div class="col-md-12">
            <label for="title" class="col-form-label"><?php echo e(__('Building Number')); ?></label>
            <input class="form-control" type="number" id="building_number" name="building_number" placeholder="<?php echo e(__('Enter Number')); ?>" required>
        </div>
        <div class="col-md-12">
            <label for="description" class="col-form-label"><?php echo e(__('Description')); ?></label>
            <textarea rows="3" class="form-control grammer_textarea" id="description" name="text" placeholder="<?php echo e(__('Enter Description')); ?>" required></textarea>
        </div>
        <div class="col-md-12">
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\ticket_task\resources\views/notes/create.blade.php ENDPATH**/ ?>