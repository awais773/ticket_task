                                                ...
                                                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if($key < 3): ?>
                                                        <a href="#" class="img_group"   data-toggle="tooltip" data-placement="top" title="<?php echo e($user->name); ?>">
                                                            <img alt="image" data-toggle="tooltip" data-original-title="<?php echo e($user->name); ?>" <?php if($user->avatar): ?> src="<?php echo e(asset($logo.$user->avatar)); ?>" <?php else: ?> avatar="<?php echo e($user->name); ?>"<?php endif; ?> class="rounded-circle mt-1 w-20" >
                                                        </a>
                                                    <?php endif; ?>
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (data.user_type == 'Client') {
                                ...
                                var avatar = (data.user.avatar) ? "src='<?php echo e($logo); ?>/" + data.user.avatar + "'" : "avatar='" + data.user.name + "'";
                                var html = "<li class='media border-bottom mb-3'>" +
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if(data.result == 1){
                            ...
                            show_toastr('<?php echo e(__('Success')); ?>', '<?php echo e(__("File not Uploded!")); ?>', 'success');
                        }
                        var delLink = '';
                        ...
                        var html = "<div class='card mb-1 shadow-none border'>" +
                           ...
                           +
                            ...
                            "                                </div>" +
                            "                                <div class='col-auto'>" +
                            "                                    <a download href='<?php echo e($logo_tasks); ?>/" + data.file + "' class='edit-icon action-btn btn-primary  btn btn-sm d-inline-flex align-items-center'>" +
                            "                                        <i class='ti ti-download'></i>" +
                            "                                    </a>" +

                                                               
                            "                                   <a  href='<?php echo e($logo_tasks); ?>/" + data.file + "' class='edit-icon action-btn btn-secondary  btn btn-sm d-inline-flex align-items-center mx-1'>" +
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ticket_task\resources\views/projects/taskboard.blade.php ENDPATH**/ ?>