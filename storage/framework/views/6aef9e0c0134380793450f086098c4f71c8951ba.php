...
<?php $__env->startSection('action-button'); ?>
    <?php if(auth()->guard('web')->check()): ?>
        <?php if(isset($currentWorkspace) && $currentWorkspace->creater->id == Auth::id()): ?>
            <a href="<?php echo e(route('zoommeeting.Calender', $currentWorkspace->slug)); ?>" class="btn btn-sm btn-primary mx-1"
                id="" data-toggle="tooltip" title="<?php echo e(__('calendar')); ?>"> <i class="ti ti-calendar"></i></a>

            <a href="#" class="btn btn-sm btn-primary" data-ajax-popup="true" data-size="lg"
                data-title="<?php echo e(__('Create New Meeting')); ?>" data-toggle="tooltip" title="<?php echo e(__('Add Meeting')); ?>"
                data-url="<?php echo e(route('zoom-meeting.create', $currentWorkspace->slug)); ?>">
    ...
    <?php if(auth()->guard('client')->check()): ?>
        <a href="<?php echo e(route('zoommeetings.Calender', $currentWorkspace->slug)); ?>" data-toggle="tooltip"
            title="<?php echo e(__('calendar')); ?>" class="btn btn-sm btn-primary mx-1" id=""> <i class="ti ti-calendar"></i>
        </a>
    <?php endif; ?>
<?php $__env->stopSection(); ?>
                                    ...
                                    <tr>
                                            ...
                                            <td>
                                                <div class="avatar-group hover-avatar-ungroup mb-3">
                                                    <?php $__currentLoopData = $item->getClients(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <a href="#" class="avatar rounded-circle avatar-sm img_group"
                                                            data-toggle="tooltip" data-placement="top" title=""
                                                            data-original-title="<?php echo e($user->name); ?>">
                                                            <img alt="<?php echo e($user->name); ?>"
                                                                <?php if($user->avatar): ?> src="<?php echo e(asset($logo . $user->avatar)); ?>" <?php else: ?> avatar="<?php echo e($user->name); ?>" <?php endif; ?>
                                                                style="border-radius: 50%; max-hight: 40px; max-width: 30px;">
                                                        </a>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </div>
                                            </td>
                                        ...
                                        <td>
                                            <?php if($item->created_by == \Auth::user()->id && $item->checkDateTime()): ?>
                                                <a href="<?php echo e($item->join_url); ?>" target="_blank"> <?php echo e(__('Start meeting')); ?>

                                                    <i class="fas fa-external-link-square-alt "></i></a>
                                            <?php elseif($item->checkDateTime()): ?>
                                                <a href="<?php echo e($item->join_url); ?>" target="_blank"> <?php echo e(__('Join meeting')); ?>
                                        ...
                                        <td>
                                            <?php if($item->checkDateTime()): ?>
                                                ...
                                                <span
                                                        class="badge badge-info p-2 px-3 bg-success rounded"><?php echo e($item->status); ?></span>
                                                <?php else: ?>
                                                    <span
                                                        class="badge badge-success p-2 px-3 bg-success rounded"><?php echo e($item->status); ?></span>
                                                <?php endif; ?>
                                            <?php else: ?>
                                                <span
                                                    class="badge badge-danger p-2 px-3 rounded"><?php echo e(__('End')); ?></span>
                                            <?php endif; ?>
                                        </td>
                                        <?php if(Auth::user()->type == 'user' && $currentWorkspace->creater->id == Auth::user()->id): ?>
                                            <td class="text-right">
                                                ...
                                                <form id="delete-form-<?php echo e($item->id); ?>"
                                                    action="<?php echo e(route('zoom-meeting.destroy', [$currentWorkspace->slug, $item->id])); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ticket_task\resources\views/zoom_meeting/index.blade.php ENDPATH**/ ?>