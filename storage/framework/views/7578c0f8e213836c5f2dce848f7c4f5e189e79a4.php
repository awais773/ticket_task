...
<div class="d-flex justify-content-end row1">
        ...
        <?php if($project_id != '-1' && Auth::user()->getGuard() != 'client'): ?>
            <div class="form-group col-sm-auto mx-2">
                
                
                    
                                <select  class="btn btn-primary w-100" id="project_tasks">
                                   <option value="">  </i><?php echo e(__('Add Task on Timesheet')); ?></option>
                                </select>
                        </div>
        <?php endif; ?>
    <?php endif; ?> 
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ticket_task\resources\views/projects/timesheet.blade.php ENDPATH**/ ?>