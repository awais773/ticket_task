                        ...
                        <ul class="list-unstyled my-5">
                            <?php if($plan->id != 1): ?>
                                <li>
                                    ...
                                    <?php echo e($plan->trial_days < 0 ? __('lifetime') : $plan->trial_days); ?>
                                ...
                                <li>
                                    ...
                                    <?php echo e($plan->enable_chatgpt == 'on' ? __('Chatgpt enabled') : __('Chatgpt disabled')); ?>
                            ...
                            <li>
                                <span class="theme-avtar">
                                    <i class="text-primary ti ti-circle-plus"></i></span>
                                <?php echo e($plan->max_workspaces < 0 ? __('lifetime') : $plan->max_workspaces); ?>
                            ...
                            <li>
                                <span class="theme-avtar">
                                    <i class="text-primary ti ti-circle-plus"></i></span>
                                <?php echo e($plan->max_users < 0 ? __('lifetime') : $plan->max_users); ?>
                            ...
                            <li>
                                <span class="theme-avtar">
                                    <i class="text-primary ti ti-circle-plus"></i></span>
                                <?php echo e($plan->max_clients < 0 ? __('lifetime') : $plan->max_clients); ?>
                            ...
                            <li>
                                <span class="theme-avtar">
                                    <i class="text-primary ti ti-circle-plus"></i></span>
                                <?php echo e($plan->max_projects < 0 ? __('lifetime') : $plan->max_projects); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ticket_task\resources\views/plans/admin.blade.php ENDPATH**/ ?>