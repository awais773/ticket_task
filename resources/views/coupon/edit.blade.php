<form method="post" action="{{ route('coupons.update', $coupon->id) }}">
    ...
    <div class="row">
        ...
        <div class="text-end col-12">
            <a href="#" data-size="lg" data-ajax-popup-over="true" class="btn btn-sm btn-primary" data-url="{{ route('generate',['coupon']) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('Generate with AI') }}" data-title="{{ __('Generate Coupon Name') }}">
        ...
        <div class="form-group col-md-12" id="auto">
                ...
                <div class="input-group">
                    {{Form::text('code',$coupon->code,array('class'=>'form-control','id'=>'auto-code','required'=>'required'))}}
