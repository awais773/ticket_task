...
@section('action-button')
    @auth('web')
      ...
      <a href="#" class="btn btn-sm btn-primary" data-toggle="tooltip" title="{{__('Create')}}" data-ajax-popup="true" data-size="lg" data-title="{{ __('Create New Request Task') }}" data-url="{{route('note.create',$currentWorkspace->slug)}}">
