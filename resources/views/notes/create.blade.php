...
<form class="" method="post" action="{{ route('notes.store',$currentWorkspace->slug) }}">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <input class="form-control" type="text" id="building_name" name="building_name" placeholder="{{ __('Enter Name') }}" required>
        </div>
        <div class="col-md-12">
            <label for="title" class="col-form-label">{{ __('Building Number') }}</label>
            <input class="form-control" type="number" id="building_number" name="building_number" placeholder="{{ __('Enter Number') }}" required>
        </div>
        <div class="col-md-12">
            <label for="description" class="col-form-label">{{ __('Description') }}</label>
            <textarea rows="3" class="form-control grammer_textarea" id="description" name="text" placeholder="{{ __('Enter Description') }}" required></textarea>
        </div>
        <div class="col-md-12">
