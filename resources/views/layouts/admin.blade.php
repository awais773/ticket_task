...
<head>
    ...
    @else
    <link rel="shortcut icon" href="@if($currentWorkspace->favicon){{asset($logo.$currentWorkspace->favicon.'?timestamp='.strtotime(isset($currentWorkspace) ? $currentWorkspace->updated_at : ''))}}@else{{asset($logo.'favicon.png')}}@endif">
    @endif
...
@endif 
    ...
    {{-- <script type="text/javascript">
        ...
        var defaults = {
        'messageLocales': {
            /*'english': 'We use cookies to make sure you can have the best experience on our website. If you continue to use this site we assume that you will be happy with it.'*/
            'english': '{{env('cookie_text')}}'
