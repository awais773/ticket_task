    ...
    <div class="row">
        <div class="col-md-12 mb-6">
            {{Form::label('file',__('Download sample Project CSV file'),['class'=>'form-control-label'])}}
            <a href="{{asset(Storage::url('uploads/sample')).'/sample-project.csv'}}" class="btn btn-xs btn-primary btn-icon-only width-auto">
        ...
        <div class="col-md-12">
            ...
            <div class="choose-file mt-3">
                <label for="file" class="">
                    ...
                    <input type="file" class="form-control choose_file_custom" name="file" id="file" data-filename="upload_file" required>
                </label>
