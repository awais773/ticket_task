    ...
    <form class="" method="post" action="@auth('web'){{ route('projects.milestone.store',[$currentWorkspace->slug,$project->id]) }}@elseauth{{ route('client.projects.milestone.store',[$currentWorkspace->slug,$project->id]) }}@endauth">
        ...
        <div class="row">
            ...
            <div class="text-end col-12">
                <a href="#" data-size="lg" data-ajax-popup-over="true" class="btn btn-sm btn-primary" data-url="{{ route('generate',['milestone']) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('Generate with AI') }}" data-title="{{ __('Generate Milestone Title & Summary') }}">
        ...
        <div class="form-group">
            ...
            <textarea rows="3" class="form-control form-control-light" id="task-summary"  name="summary"></textarea>
        </div>
     </div>
