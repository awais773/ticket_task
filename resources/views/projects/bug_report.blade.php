...
@section('action-button')
    @if ((isset($permissions) && in_array('create bug report', $permissions)) ||
        ...
        <a href="#" class="btn btn-sm btn-primary" data-ajax-popup="true" data-size="lg"
            ...
            data-url="{{ route($client_keyword . 'projects.bug.report.create', [$currentWorkspace->slug, $project->id]) }}"
            data-toggle="tooltip" title="{{ __('Add Bug') }}"><i class="ti ti-plus"></i></a>
    @endif
                                            ...
                                            alt=""> -->
                                                <div class="position-absolute top-0 start-0 pt-3 ps-3">
                                                    ...
                                                    @elseif($bug->priority == 'High')
                                                        <div class="badge bg-danger p-2 px-3 rounded"> {{ $bug->priority }}
                                                        </div>
                                                    @endif
                                                </div>
                                                <div class="card-header border-0 pb-0 position-relative">
                                                    ...
                                                    <div style="padding: 30px 2px;"> <a href="#" data-size="lg"
                                                            ...
                                                            data-ajax-popup="true" data-title="{{ __('Bug Detail') }}"
                                                            class="h6 task-title">
                                                            <h5>{{ $bug->title }}</h5>
                                                        </a></div>
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        <ul class="list-inline mb-0">
                                                            ...
                                                            <li class="list-inline-item d-inline-flex align-items-center">
                                                                ...
                                                                {{ $bug->comments->count() }} {{ __('Comments') }}</li>
...
@if ($project && $currentWorkspace)
    @push('scripts')
        ...
        <script>
            ...
            function(a) {
                "use strict";
                @if ((isset($permissions) && in_array('move bug report', $permissions)) ||
        ...
        <script>
            ...
            $(document).on('submit', '#form-file', function(e) {
                ...
                $.ajax({
                    ...
                    processData: false,
                    success: function(data) {
                        show_toastr('{{ __('Success') }}', '{{ __('File Upload Successfully!') }}' + '</br>' + '<span class="text-danger">' + data.result + '</span>', 'success',
                            'success');
                        //console.log(data);
                        var delLink = '';
