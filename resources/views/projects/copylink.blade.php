        ...
        <select name="language" id="language" class=" btn-primary btn "
            ...
            @foreach (App\Models\Utility::languages() as $language)
                ...
                @if ($lang == $language) selected @endif
                    value="{{ route('projects.link', [$currentWorkspace->slug, \Illuminate\Support\Facades\Crypt::encrypt($project->id), $language]) }}">{{ ucfirst( \App\Models\Utility::getlang_fullname($language)) }}
                </option>
            @endforeach
        </select>
    </a>
                        ...
                        <div class="card-body" >
                            <section class="section py-3">
                                @if ($project && $currentWorkspace)
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div style="min-height:70vh" class="row kanban-wrapper horizontal-scroll-cards"
                                                data-toggle="dragula"
