                            ...
                            <div data-v-7d9d14b5="" class="d-inner" style="border-right: 50px solid {{$color}};">
                                <div data-v-7d9d14b5="" class="row">
                                    <div data-v-7d9d14b5="" class="col-3"><h1 data-v-7d9d14b5="" class="fancy-title tu mb5" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('INVOICE')}}</h1>
                                        <h3 data-v-7d9d14b5="">{{App\Models\Utility::invoiceNumberFormat($invoice->invoice_id)}}</h3>
                                        <p data-v-7d9d14b5="">{{App\Models\Utility::dateFormat($invoice->issue_date)}}</p>
                                    </div>
                                    <div data-v-7d9d14b5="" class="col-1"><img data-v-7d9d14b5="" class="d-logo" src="@if($currentWorkspace->logo) {{asset($logo.$currentWorkspace->logo)}} @else{{asset($logo.'logo-light.png')}} @endif" style="max-width: 150px;"></div>
                                    ...
                                    <div data-v-7d9d14b5="" class="col-33">
                                        <table data-v-7d9d14b5="" class="summary-table">
                                            ...
                                            <tr data-v-7d9d14b5="">
                                                ...
                                                <td data-v-7d9d14b5="" class="text-right">{{App\Models\Utility::dateFormat($invoice->due_date)}}</td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
