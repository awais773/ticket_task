                            ...
                            <div data-v-363339a0="" class="d-inner">
                                <div data-v-363339a0="" class="row">
                                    ...
                                    <div data-v-363339a0="" class="col-1">
                                        <img data-v-363339a0="" src="@if($currentWorkspace->logo) {{asset($logo.$currentWorkspace->logo)}} @else{{asset($logo.'logo-light.png')}} @endif" style="max-width: 150px" class="d-logo">
                                    </div>
                                    ...
                                    <div data-v-363339a0="" class="col-33">
                                        <table data-v-363339a0="" class="summary-table">
                                            ...
                                            <tr data-v-363339a0="">
                                                ...
                                                <td data-v-363339a0="" class="text-right">{{App\Models\Utility::invoiceNumberFormat($invoice->invoice_id)}}</td>
                                            </tr>
                                            <tr data-v-363339a0="">
                                            ...
                                            <tr data-v-363339a0="">
                                                ...
                                                <td data-v-363339a0="" class="text-right">{{App\Models\Utility::dateFormat($invoice->issue_date)}}</td>
                                            </tr>
                                            <tr data-v-363339a0="">
                                                <td data-v-363339a0="" class="tu fwb" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('Due Date')}}:</td>
                                                <td data-v-363339a0="" class="text-right">{{App\Models\Utility::dateFormat($invoice->due_date)}}</td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
