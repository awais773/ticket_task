        ...
        <div class="col-12">
            ...
            <div class="row">
                ...
                @if (!empty($order->receipt))
                    @if($plan->storage_limit > Auth::user()->storage_limit && $plan->storage_limit != -1)
                    <div class="col-md-6">
                        <a class="btn btn-primary" href="{{  url('storage/uploads/invoice_receipt/' .$order->receipt) }}" download="">
