                            ...
                            <div data-v-136bf9b5="" class="d-inner">
                                <div data-v-136bf9b5="" class="row">
                                    <div data-v-136bf9b5="" class="col-66">
                                        <img data-v-136bf9b5="" src="@if($currentWorkspace->logo) {{asset($logo.$currentWorkspace->logo)}} @else{{asset($logo.'logo-light.png')}} @endif" class="d-logo" style="max-width: 200px;">
                                    ...
                                    <div data-v-136bf9b5="" class="col-33">
                                        <table data-v-136bf9b5="" class="summary-table">
                                            ...
                                            <tr data-v-136bf9b5="">
                                                ...
                                                <td data-v-136bf9b5="" class="text-right">{{App\Models\Utility::invoiceNumberFormat($invoice->invoice_id)}}</td>
                                            </tr>
                                            <tr data-v-136bf9b5="">
                                            ...
                                            <tr data-v-136bf9b5="">
                                                ...
                                                <td data-v-136bf9b5="" class="text-right">{{App\Models\Utility::dateFormat($invoice->issue_date)}}</td>
                                            </tr>
                                            <tr data-v-136bf9b5="">
                                                <td data-v-136bf9b5="" class="fwb">{{__('Due Date')}}:</td>
                                                <td data-v-136bf9b5="" class="text-right">{{App\Models\Utility::dateFormat($invoice->due_date)}}</td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
