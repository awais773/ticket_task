                                ...
                                <tbody>
                                  @foreach($contractTypes as $contractType)
                                    <tr>
                                        ...
                                        @auth('web')
                                            <td class="text-right">
                                                <a href="#" class="action-btn btn-info  btn btn-sm d-inline-flex align-items-center" data-url="{{route('contract_type.edit',[!empty($currentWorkspace)?$currentWorkspace->slug:0,$contractType->id])}}" data-size="md" data-toggle="tooltip" title="{{ __('Edit Contract Type') }}"  data-ajax-popup="true" data-title="{{__('Edit Contract Type')}}">
                                                ...
                                                {!! Form::open(['method' => 'DELETE', 'route' => ['contract_type.destroy',[!empty($currentWorkspace)?$currentWorkspace->slug:0,$contractType->id]],'id'=>'delete-form-'.$contractType->id]) !!}
                                                {!! Form::close() !!}
                                            </td>
                                        @endauth
                                    </tr>
