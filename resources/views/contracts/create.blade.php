...
<div class="modal-body">
    <div class="row">
        ...
        <div class="text-end col-12">
            <a href="#" data-size="lg" data-ajax-popup-over="true" class="btn btn-sm btn-primary" data-url="{{ route('generate',['contract']) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('Generate with AI') }}" data-title="{{ __('Generate Contract Subject & Description') }}">
        ...
        <div class="form-group col-md-12">
            ...
            @if(count($contractType) <= 0)
                <div class="text-muted text-xs">
                    {{__('Please create new contract type')}} <a href="{{route('contract_type.index',!empty($currentWorkspace)?$currentWorkspace->slug:0)}}">{{__('here')}}</a>.
                </div>
            @endif
        </div>
        <div class="col-md-12">
