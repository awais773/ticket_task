                ...
                <div class="col-xl-9">
                                                    ...
                                                    <div class="border card p-3">
                                                        <div class="form-check">
                                                            <input type="radio" name="bank_payment_frequency"
                                                                ...
                                                                data-price="{{ (env('CURRENCY_SYMBOL') ? env('CURRENCY_SYMBOL') : '$') . $plan->monthly_price }}"
                                                                autocomplete="off" @if($frequency == 'monthly') checked="" @endif id="">
                                                            <label class="form-check-label d-block" for="">
                                                                <span>
                                                                    <span class="h5 d-block"><strong class="float-end">
                                                                            {{ (env('CURRENCY_SYMBOL') ? env('CURRENCY_SYMBOL') : '$') . $plan->monthly_price }}</strong>{{ __('Monthly Payments') }}</span>
                                                                </span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="border card p-3">
                                                        <div class="form-check">
                                                            <input type="radio" name="bank_payment_frequency"
                                                                ...
                                                                data-price="{{ (env('CURRENCY_SYMBOL') ? env('CURRENCY_SYMBOL') : '$') . $plan->annual_price }}"
                                                                autocomplete="off"
                                                                class="form-check-input input-primary payment_frequency" @if($frequency == 'annual') checked="" @endif
                                                                id="">
                                                            <label class="form-check-label d-block" for="">
                                                                <span>
                                                                    <span class="h5 d-block"><strong class="float-end">
                                                                            {{ (env('CURRENCY_SYMBOL') ? env('CURRENCY_SYMBOL') : '$') . $plan->annual_price }}</strong>{{ __('Annual Payments') }}</span>
                                                                </span>
                                                            </label>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="card-footer text-end py-0 pe-2 border-0">
                                                        ...
                                                        <button type="submit"
                                                            class="btn btn-primary"> {{ __('Checkout') }}(<span
                                            ...
                                            <div class="border card p-3">
                                                <div class="form-check">
                                                    <input type="radio"
                                                        ...
                                                        value="monthly"
                                                        data-price="{{ (env('CURRENCY_SYMBOL') ? env('CURRENCY_SYMBOL') : '$') . $plan->monthly_price }}"
                                                        autocomplete="off" @if($frequency == 'monthly') checked="" @endif>
                                                    <label class="form-check-label d-block" for="">
                                                        <span>
                                                            <span class="h5 d-block"><strong class="float-end">
                                                                    {{ (env('CURRENCY_SYMBOL') ? env('CURRENCY_SYMBOL') : '$') . $plan->monthly_price }}</strong>{{ __('Monthly Payments') }}
                                                            </span>
                                                        </span>
                                                    </label>
                                                </div>
                                            ...
                                            <div class="border card p-3">
                                                <div class="form-check">
                                                    <input type="radio" name="paypal_payment_frequency"
                                                        class="form-check-input input-primary payment_frequency"
                                                        data-from="paypal" value="annual" @if($frequency == 'annual') checked="" @endif
                                                        data-price="{{ (env('CURRENCY_SYMBOL') ? env('CURRENCY_SYMBOL') : '$') . $plan->annual_price }}"
                                                        autocomplete="off">
                                                    <label class="form-check-label d-block" for="">
                                                        <span>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="border card p-3">
                                                <div class="form-check">
                                                    <input type="radio"
                                                        class="form-check-input input-primary payment_frequency"
                                                        name="paystack_payment_frequency" data-from="paystack" @if($frequency == 'annual') checked="" @endif
                                                        value="annual"
                                                        data-price="{{ (env('CURRENCY_SYMBOL') ? env('CURRENCY_SYMBOL') : '$') . $plan->annual_price }}"
                                                        autocomplete="off">
                                                    <span>
                                            ...
                                            <div class="border card p-3">
                                                <div class="form-check">
                                                    <input type="radio"
                                                        ...
                                                        name="paytm_payment_frequency" data-from="paytm" value="annual" @if($frequency == 'annual') checked="" @endif
                                                        data-price="{{ (env('CURRENCY_SYMBOL') ? env('CURRENCY_SYMBOL') : '$') . $plan->annual_price }}"
                                                        autocomplete="off">
                                                    <span>
                                                        <span class="h5 d-block"><strong class="float-end">
                                            ...
                                            <div class="border card p-3">
                                                <div class="form-check">
                                                    <input type="radio"
                                                        ...
                                                        name="mollie_payment_frequency" data-from="mollie" value="annual" @if($frequency == 'annual') checked="" @endif
                                                        data-price="{{ (env('CURRENCY_SYMBOL') ? env('CURRENCY_SYMBOL') : '$') . $plan->annual_price }}"
                                                        autocomplete="off">
                                                    <span>
                                                        <span class="h5 d-block"><strong class="float-end">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="border card p-3">
                                                <div class="form-check">
                                                    <input type="radio"
                                                        class="form-check-input input-primary payment_frequency skrill_frequency"
                                                        name="skrill_payment_frequency" data-from="skrill" value="annual" @if($frequency == 'annual') checked="" @endif
                                                        data-price="{{ (env('CURRENCY_SYMBOL') ? env('CURRENCY_SYMBOL') : '$') . $plan->annual_price }}"
                                                        autocomplete="off">
                                                    <span>
                                                        <span class="h5 d-block"><strong class="float-end">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="border card p-3">
                                                <div class="form-check">
                                                    <input type="radio"
                                                        class="form-check-input input-primary toyyibpay_frequency payment_frequency" name="toyyibpay_payment_frequency"
                                                        data-from="toyyibpay" value="monthly"
                                                        data-price="{{ (env('CURRENCY_SYMBOL') ? env('CURRENCY_SYMBOL') : '$') . $plan->monthly_price }}"
                                                        autocomplete="off" @if($frequency == 'monthly') checked="" @endif>
                                                    <label class="form-check-label d-block" for="">
                                                        <span>
                    ...
                    @if (isset($paymentSetting['is_payfast_enabled']) && $paymentSetting['is_payfast_enabled'] == 'on')
                        ...
                        <div id="payfast_payment" class="card">
                            ...
                            <div class="card-body">
                                <form role="form" action={{ route('payfast.payment' ) }} method="post" class="require-validation" id="payfast-payment-form" >
                                    @csrf
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="border card p-3">
                                                <div class="form-check">
                                                    <input type="radio"
                                                        class="form-check-input input-primary payfast_frequency payment_frequency" name="payfast_payment_frequency"
                                                        data-from="payfast" value="monthly"
                                                        data-price="{{ (env('CURRENCY_SYMBOL') ? env('CURRENCY_SYMBOL') : '$') . $plan->monthly_price }}"
                                                        autocomplete="off" @if($frequency == 'monthly') checked="" @endif>
                                                    <label class="form-check-label d-block" for="">
                                                        <span>
                                            ...
                                            <div class="border card p-3">
                                                <div class="form-check">
                                                    <input type="radio" name="iyzipay_payment_frequency"
                                                        class="form-check-input input-primary payment_frequency"
                                                        data-from="iyzipay" value="annual" @if($frequency == 'annual') checked="" @endif
                                                        data-price="{{ (env('CURRENCY_SYMBOL') ? env('CURRENCY_SYMBOL') : '$') . $plan->annual_price }}"
                                                        autocomplete="off">
                                                    <label class="form-check-label d-block" for="">
                                                        <span>
                    ...
                    @if (isset($paymentSetting['is_sspay_enabled']) && $paymentSetting['is_sspay_enabled'] == 'on')
                        <div id="sspay_payment" class="card">
                            ...
                            <div class="card-body">
                                <form role="form" action="{{ route('plan.pay.with.sspay') }}" method="post" class=""
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="border card p-3">
                                                <div class="form-check">
                                                    <input type="radio"
                                                        class="form-check-input input-primary sspay_frequency payment_frequency" name="sspay_payment_frequency"
                                                        data-from="sspay" value="monthly"
                                                        data-price="{{ (env('CURRENCY_SYMBOL') ? env('CURRENCY_SYMBOL') : '$') . $plan->monthly_price }}"
                                                        autocomplete="off" @if($frequency == 'monthly') checked="" @endif>
                                                    <label class="form-check-label d-block" for="">
                                                        <span>
                    ...
                    @if (isset($paymentSetting['is_paytab_enabled']) && $paymentSetting['is_paytab_enabled'] == 'on')
                        <div id="paytab_payment" class="card">
                            ...
                            <div class="card-body">
                                <form role="form" action="{{ route('plan.pay.with.paytab') }}" method="post" class=""
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="border card p-3">
                                                <div class="form-check">
                                                    <input type="radio"
                                                        class="form-check-input input-primary paytab_frequency payment_frequency" name="paytab_payment_frequency"
                                                        data-from="paytab" value="monthly"
                                                        data-price="{{ (env('CURRENCY_SYMBOL') ? env('CURRENCY_SYMBOL') : '$') . $plan->monthly_price }}"
                                                        autocomplete="off" @if($frequency == 'monthly') checked="" @endif>
                                                    <label class="form-check-label d-block" for="">
                                                        <span>
                    ...
                    @if (isset($paymentSetting['is_benefit_enabled']) && $paymentSetting['is_benefit_enabled'] == 'on')
                        <div id="benefit_payment" class="card">
                            ...
                            <div class="card-body">
                                <form role="form" action="{{ route('plan.pay.with.benefit') }}" method="post" class=""
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="border card p-3">
                                                <div class="form-check">
                                                    <input type="radio"
                                                        class="form-check-input input-primary benefit_frequency payment_frequency" name="benefit_payment_frequency"
                                                        data-from="benefit" value="monthly"
                                                        data-price="{{ (env('CURRENCY_SYMBOL') ? env('CURRENCY_SYMBOL') : '$') . $plan->monthly_price }}"
                                                        autocomplete="off" @if($frequency == 'monthly') checked="" @endif>
                                                    <label class="form-check-label d-block" for="">
                                                        <span>
                    ...
                    @if (isset($paymentSetting['is_cashfree_enabled']) && $paymentSetting['is_cashfree_enabled'] == 'on')
                        <div id="cashfree_payment" class="card">
                            ...
                            <div class="card-body">
                                <form role="form" action="{{ route('plan.pay.with.cashfree') }}" method="post" class=""
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="border card p-3">
                                                <div class="form-check">
                                                    <input type="radio"
                                                        class="form-check-input input-primary cashfree_frequency payment_frequency" name="cashfree_payment_frequency"
                                                        data-from="cashfree" value="monthly"
                                                        data-price="{{ (env('CURRENCY_SYMBOL') ? env('CURRENCY_SYMBOL') : '$') . $plan->monthly_price }}"
                                                        autocomplete="off" @if($frequency == 'monthly') checked="" @endif>
                                                    <label class="form-check-label d-block" for="">
                                                        <span>
                    ...
                    @if (isset($paymentSetting['is_aamarpay_enabled']) && $paymentSetting['is_aamarpay_enabled'] == 'on')
                        <div id="aamarpay_payment" class="card">
                            ...
                            <div class="card-body">
                                <form role="form" action="{{ route('plan.pay.with.aamarpay') }}" method="post" class=""
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="border card p-3">
                                                <div class="form-check">
                                                    <input type="radio"
                                                        class="form-check-input input-primary aamarpay_frequency payment_frequency" name="aamarpay_payment_frequency"
                                                        data-from="aamarpay" value="monthly"
                                                        data-price="{{ (env('CURRENCY_SYMBOL') ? env('CURRENCY_SYMBOL') : '$') . $plan->monthly_price }}"
                                                        autocomplete="off" @if($frequency == 'monthly') checked="" @endif>
                                                    <label class="form-check-label d-block" for="">
                                                        <span>
                    ...
                    @if (isset($paymentSetting['is_paytr_enabled']) && $paymentSetting['is_paytr_enabled'] == 'on')
                        <div id="paytr_payment" class="card">
                            ...
                            <div class="card-body">
                                <form role="form" action="{{ route('plan.pay.with.paytr') }}" method="post" class=""
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="border card p-3">
                                                <div class="form-check">
                                                    <input type="radio"
                                                        class="form-check-input input-primary paytr_frequency payment_frequency" name="paytr_payment_frequency"
                                                        data-from="paytr" value="monthly"
                                                        data-price="{{ (env('CURRENCY_SYMBOL') ? env('CURRENCY_SYMBOL') : '$') . $plan->monthly_price }}"
                                                        autocomplete="off" @if($frequency == 'monthly') checked="" @endif>
                                                    <label class="form-check-label d-block" for="">
                                                        <span>
...
@push('scripts')
    ...
    @if (!empty($paymentSetting['is_stripe_enabled']) &&
    ...
    <script type="text/javascript">
        ...
        @if (!empty($paymentSetting['is_paystack_enabled']) &&
        ...
        @if (!empty($paymentSetting['is_flutterwave_enabled']) &&
        ...
        @if (!empty($paymentSetting['is_razorpay_enabled']) &&
