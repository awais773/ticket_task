  ...
  <head>
    ...
    @else
      ...
      <link rel="icon" href="{{(isset($currentWorkspace->favicon) && !empty($currentWorkspace->favicon)?asset(Storage::url($currentWorkspace->favicon)):'favicon.png')}}" type="image" sizes="16x16">
   @endif
