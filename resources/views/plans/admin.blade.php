                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled my-5">
                            ...
                            <li>
                                <span class="theme-avtar">
                                    <i class="text-primary ti ti-circle-plus"></i></span>
                                {{ $plan->max_workspaces < 0 ? __('lifetime') : $plan->max_workspaces }}
                                {{ __('Workspaces') }}
                            </li>
                            <li>
                                <span class="theme-avtar">
                                    <i class="text-primary ti ti-circle-plus"></i></span>
                                {{ $plan->max_users < 0 ? __('lifetime') : $plan->max_users }}
                                {{ __('Users Per Workspace') }}
                            </li>
                            <li>
                                <span class="theme-avtar">
                                    <i class="text-primary ti ti-circle-plus"></i></span>
                                {{ $plan->max_clients < 0 ? __('lifetime') : $plan->max_clients }}
                                {{ __('Clients Per Workspace') }}
                            </li>
                            <li>
                                <span class="theme-avtar">
                                    <i class="text-primary ti ti-circle-plus"></i></span>
                                {{ $plan->max_projects < 0 ? __('lifetime') : $plan->max_projects }}
