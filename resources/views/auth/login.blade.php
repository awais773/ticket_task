                    ...
                    <div class="col-xl-6">
                        <div class="card-body">
                                ...
                                <div class="">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="email" class="form-control  @error('email') is-invalid @enderror"
                                            ...
                                            autocomplete="email" autofocus placeholder="{{ __('Enter Your Email') }}">
                                    </div>
                                    <div class="form-group mb-3">
                            ...
                            <div class="d-grid mt-3">
                                    <a
                                        href="{{ route('client.login', $lang) }}" type="button" class="btn btn-primary btn-block" style="color:#fff">
                                        {{ __('Client Login') }}</a>
                            </div>
                            <div class="row mt-4">
                                <div class="">
                                        ...
                                        <select name="language" id="language" class=" btn-primary btn "
                                            ...
                                            @foreach (App\Models\Utility::languages() as $language)
                                                <option class="login_lang" @if ($lang == $language) selected @endif
                                                    value="{{ route('login', $language) }}">{{ ucfirst( \App\Models\Utility::getlang_fullname($language)) }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </a>
