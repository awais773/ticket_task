                                    ...
                                    <tr>
                                        ...
                                        {{-- <td>
                                            <div class="font-style font-weight-bold">
                                                {{ $prequest->duration == 'monthly' ? _('One Month') : _('One Year') }}
                                            </div>
                                        </td> --}}
                                        <td>
                                            <div class="font-weight-bold">{{ $prequest->name }}</div>
                                              </td>
                                              <td>
                                             <div class="font-weight-bold">{{ $prequest->email }}</div>
                                               </td>
                                               <td>
                                              <div class="font-weight-bold">{{ $prequest->phone }}</div>
                                                </td>
                                                {{-- <td>
                                               <div class="font-weight-bold">{{ $prequest->plane_id }}</div>

                                                 </td> --}}
                                                 <td>
                                                <div class="font-weight-bold">{{ $prequest->subject }}</div>
                                                   </td>
                                                   <td>
